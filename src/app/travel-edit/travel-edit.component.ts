...
export class TravelEditComponent implements OnInit {
  ...
  private initForm(){
    ...
    if(this.travel.endingTripDate && this.travel.favoritePlate && this.travel.startingTripDate){
      this.travelForm.controls['startingDate'].setValue(this.travel.startingTripDate);
      this.travelForm.controls['endingDate'].setValue(this.travel.endingTripDate);
      this.travelForm.controls['favoritePlate'].setValue(this.travel.favoritePlate);
    }
    else {
